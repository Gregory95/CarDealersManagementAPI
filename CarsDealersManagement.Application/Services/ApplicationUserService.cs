...
namespace CarsDealersManagement.Application.Services
{
        ...
        SignInManager<ApplicationUser> signInManager) : IApplicationUserService
    {
        ...
        public async Task<TokenDto> GetAccessTokenAsync(LoginRequestDto message)
        {
            ...
            if (user == null)
            {
                throw new UnauthorizedAccessException("Given user name does not exist in the system");
            }

            if (!await _userManager.CheckPasswordAsync(user, message.Password))
            {
                await _userManager.AccessFailedAsync(user);
                throw new UnauthorizedAccessException("Username or password and not valid.");
            }
        ...
        public async Task<LoginResponseDto> LoginUserAsync(LoginRequestDto message)
        {
            ...
            {
                throw new UnauthorizedAccessException("Your account is locked due to multiple failed login attempts. Please contact the system administrator.");
            }

            if (!await _signInManager.CanSignInAsync(user))
            {
                throw new UnauthorizedAccessException("A confirmation email had been sent to you to confirm your account");
            }
            ...
            if (!await _userManager.CheckPasswordAsync(user, message.Password))
            {
                ...
                throw new UnauthorizedAccessException("Username or password combination is not correct.");
            }
            ...
            {
                throw new UnauthorizedAccessException("Enter the code generated by your authenticator app.");
            }
