        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasFirstLogin = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactPersons_Showrooms_ShowroomId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactPersons_Id_FirstName_LastName",
                table: "ContactPersons",
                columns: new[] { "Id", "FirstName", "LastName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContactPersons_Id_PhoneNumber",
                table: "ContactPersons",
                columns: new[] { "Id", "PhoneNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContactPersons_ShowroomId",
                table: "ContactPersons",
                column: "ShowroomId");

            migrationBuilder.CreateIndex(
                name: "IX_Dealers_Id_FirstName_LastName",
                table: "Dealers",
                columns: new[] { "Id", "FirstName", "LastName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Showrooms_Id_Name_Location",
                table: "Showrooms",
